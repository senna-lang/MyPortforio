      ...
      <div className=" modal flex  leading-6">
        <div className=" w-1/3 p-5">
          ...
          <p className=" mb-2 px-5">
            notionのdatabaseに記事を書いてそのままブログに投稿できるNotionBlogです。私自身のブログとして実際に運用して行くことを想定して作りました。Notion自体は以前から簡単なメモからタスク管理など日頃からよく触るものであり、Notionで記事を書いてそのままブログにアップロードできるというのは日々のルーティンワークに取り入れやすく、記事を書いて投稿するハードルが下がるのではと言う思いから作り始めました。
          </p>
          <ul className="mb-4 px-5">
            ...
            <li>
              ...
              >
                https://github.com/senna-lang/MyNotionBlog
              </Link>
            </li>
            <li>
              <span>Blog記事:  </span>
              ...
              >
                https://nextjs-myblog.vercel.app/articles/notionblog
              </Link>
            </li>
          </ul>
